//Lab 4 - Ejercicio 13 - Programa para insertar un elemento ordenado en la una lista con elementos ya ordenados
#include <stdio.h>
#include <stdlib.h>
typedef struct Nodo{
	int valor;
...
int main(int argc, char const *argv[])
{
	...
	printf("Ahora ingrese una numero para insertalo: ");
	scanf("%d",&num);
